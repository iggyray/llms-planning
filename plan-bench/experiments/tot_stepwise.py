...
exp_tot_prompt = '{}\n\nConsidering the goal state and the current plan, explain 2 possible actions then conclude in the last line "The possible actions are: 1. <a> 2. <b>" where a, b are your explained actions.'

exp_vote_prompt = 'Here are choices for the 1st step:\n{}\n\nDecide which choice is most promising in reaching the goal state. Analyze each choice in detail, then conclude in the last line "The best choice is <>" where <> is the chosen choice.'
...
tot_prompt_1 = 'What are 2 possible actions for step 1 in reaching the goal state? Explain your actions, then conclude in the last line "The possible actions are: 1. {a} 2. {b}" where a, b are the possible actions.'
